...
class amazon_spider(scrapy.Spider):
    name = 'et_all_media_and_entertainment_article'
    start_urls = ['https://economictimes.indiatimes.com/industry/media-/-entertainment/entertainment',
'https://economictimes.indiatimes.com/industry/media-/-entertainment/media']
