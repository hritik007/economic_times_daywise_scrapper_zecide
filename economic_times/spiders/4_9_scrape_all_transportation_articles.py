...
class amazon_spider(scrapy.Spider):
    name = 'et_all_transportation_article'
    start_urls = ['https://economictimes.indiatimes.com/industry/transportation/railways',
...
'https://economictimes.indiatimes.com/industry/transportation/roadways/articlelist/58456933.cms']
